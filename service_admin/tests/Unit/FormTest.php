...
class FormTest extends TestCase
{
    ...
    {
             $this->post('api/admin/register',['nom'=>"benmaiza","prenom"=>"mohamed","sexe"=>'Male',"dateN"=>'2000-12-12','adresse'=>'alger']);
   $this->assertCount(1,Administrateur::all());
      /* $respons=$this->get('/form-admin');
